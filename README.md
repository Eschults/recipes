...
My collection of recipes in [RecipeMD](https://recipemd.org/specification.html), forked
from [ssaunier/recipes](https://github.com/ssaunier/recipes). The recipe format, the
repository layout and the validation workflow are unchanged here, and
[the upstream README](https://github.com/ssaunier/recipes#readme) documents all three.

They are served at [cookbook.eschults.org](https://cookbook.eschults.org) by
[Eschults/cookbook](https://github.com/Eschults/cookbook), which reads this repository
straight from the GitHub API: push a recipe here and it shows up there.
...
[MIT](LICENSE) © Sébastien Saunier for everything inherited from upstream, including the
